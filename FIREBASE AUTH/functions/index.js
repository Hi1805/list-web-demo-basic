...
exports.addAdminRole = functions.https.onCall((data, context) => { // return 1 data
  ...
  if(context.auth.token.admin !==true){// 
        ...
        return {message:"You Are is not Admin",
              ...
              //  data1 : data
              //context0:context,//eror Port https://us-central1-fir-auth-c83e1.cloudfunctions.net/addAdminRole 500
              context1:+"day cua la cua context"+context, //[object object]
              context2: context.auth.token
          };
  }
